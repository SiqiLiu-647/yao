...
modulation_ampv = [0.05,0.1,0.2,0.3];
modulation_nptsv  = [16,20,24,28,32,36];
...
for (ll=1;ll<=numberof(modulation_nptsv);ll++) {
  ...
  range,0.0,0.6;//15 mag
  //range,0.0,0.1//16 mag
...
pltitle, "Pyramid WFS for 24 pixels setup 10 mag star"
window,0;